...
const journey = [
  {
    ...
    desc: "Sign up and set up your profile in under a minute.",
  },
  {
    n: "02",
    title: "Pick a Slot",
    desc: "Browse upcoming sessions and pick your best time.",
  },
  {
    n: "03",
    title: "Confirm Booking",
    desc: "Reserve your class and keep the session in your calendar.",
  },
  {
    n: "04",
    title: "Join & Speak",
    desc: "Open your Meet link and practice live with your teacher.",
  },
];
...
const testimonials = [
  {
    quote:
      "I have been learning Nepali with Shishab from Lingo & Landscapes for about a month now, and I couldn't be happier. Shishab is an incredibly engaging and fun teacher, which is exactly what I need to stay motivated. Beyond the language, he is deeply knowledgeable about Nepali culture and customs, making every class feel like a cultural journey rather than just a grammar lesson. He is supportive, professional, and makes learning feel easy. Highly recommended for anyone wanting to truly understand Nepal",
    name: "Ka Sia",
    avatarUrl:
      "https://lh3.googleusercontent.com/a-/ALV-UjUqZ8RN9zMTnTdvWx-KBXjwxlraAc9Gqa8VGXLpTHFzj0xdZoM=w144-h144-p-rp-mo-ba2-br100",
    avatar: "K",
    reviews: 11,
    photos: 4,
    posted: "3 months ago",
  ...
  {
    quote:
      "I have been having lessons with Shishab to improve my Nepali and have enjoyed them a lot so far. He takes his time to explain topics in detail and makes sure that our learning goals are met. His knowledge of the Nepali language and culture is very inspiring. I can highly recommend his lessons! Dhanyavaad, Shishab ji ;-)",
    name: "Jeanine Eberle",
    avatar: "J",
    reviews: 6,
    photos: 1,
...
const faqItems = [
  {
    q: "Do I need any prior knowledge of Nepali?",
    a: "No prior knowledge is required! We offer classes starting from the absolute basics, covering the alphabet and simple everyday phrases.",
  },
  {
    q: "How are classes conducted?",
    a: "Classes are conducted live over Google Meet. You and your tutor will interact face-to-face in a structured 1-on-1 session.",
  },
  {
    q: "What timezone are classes in?",
    a: "Our system automatically handles timezone conversions, showing you available slots in your local timezone.",
  },
  {
    q: "Can I cancel a booking?",
    a: "Yes, you can cancel or reschedule a booking up to 24 hours in advance without any penalty.",
  },
  {
    q: "How many students are in each class?",
    a: "All our sessions are 1-on-1 private tutoring to ensure maximum speaking practice and personalized feedback.",
  },
  {
    q: "What do I need to join a class?",
    a: "You just need a stable internet connection, a microphone, and a device (computer, tablet, or phone) that can run Google Meet.",
  },
];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              ...
              <p className="mt-5 max-w-xl text-base leading-relaxed text-slate-200 md:text-lg">
                Book private sessions with native speakers, get direct feedback,
                and build fluency that actually works in daily life.
              </p>

              <div className="mt-8 flex flex-wrap gap-3">
                {isAuthenticated && !isAdmin ? (
                  <Link to="/slots" className="btn-primary px-7 py-3 text-base">
                    Browse Slots
                  </Link>
                ) : isAdmin ? (
                  <Link to="/admin" className="btn-primary px-7 py-3 text-base">
                    Go to Admin
                  </Link>
                ) : (
                  <>
            ...
            <div className="rounded-3xl border border-white/20 bg-slate-900/35 p-6 text-white shadow-2xl shadow-black/20 backdrop-blur-xl md:p-7">
              <div className="section-label text-crimson-300">
                Today in Class
              </div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-slate-200">
                Learn greetings, introductions, and practical phrases you can
                use in your next conversation.
              </p>
      ...
      <section id="about" className="shell mt-20 scroll-mt-32 md:mt-32">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-base text-slate-500 leading-relaxed text-center">
            Lingo and Landscapes is a leading Nepali language training and
            cultural travel company based in Nepal, dedicated to helping
            foreigners learn Nepali and experience authentic local culture.
          </p>
          <div className="mt-6">
            <Link
              to="/about"
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <article className="card-soft group flex flex-col border-l-4 border-crimson-500 transition hover:-translate-y-1 hover:shadow-md">
            ...
            <h3 className="mb-3 text-lg font-bold text-nepal-dark">
              International Students
            </h3>
            <p className="text-sm leading-relaxed text-slate-500">
              Learners from 40+ countries join our classes with automatic
              timezone conversion.
            </p>
          </article>
          ...
          <article className="card-soft group flex flex-col border-l-4 border-crimson-500 transition hover:-translate-y-1 hover:shadow-md">
            ...
            <p className="text-sm leading-relaxed text-slate-500">
              Every instructor is a certified Nepali language teacher based in
              Nepal.
            </p>
          </article>
          ...
          <article className="card-soft group flex flex-col border-l-4 border-crimson-500 transition hover:-translate-y-1 hover:shadow-md">
            ...
            <p className="text-sm leading-relaxed text-slate-500">
              From Devanagari script basics to conversational fluency — three
              clear levels.
            </p>
          </article>
        </div>
      ...
      <section id="services" className="shell mt-20 scroll-mt-32 md:mt-32">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-slate-500 leading-relaxed text-center">
            Professional visa guidance and documentation support for staying and
            studying in Nepal.
          </p>
        </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <article className="card group hover:-translate-y-1 hover:shadow-lg">
            <div className="mb-4 inline-flex rounded-xl bg-crimson-50 p-3 text-2xl transition group-hover:bg-crimson-100">
              <GraduationCap size={22} aria-hidden="true" />
            </div>
            <h3 className="text-base font-bold text-nepal-dark">
              Student Visa
            </h3>
            <p className="mt-2 text-sm leading-relaxed text-slate-500">
              Guidance for students seeking to study in Nepal with complete
          ...
          <article className="card group hover:-translate-y-1 hover:shadow-lg">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-500">
              Comprehensive support for entrepreneurs and business professionals
              entering Nepal.
            </p>
          </article>
          ...
          <article className="card group hover:-translate-y-1 hover:shadow-lg">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-500">
              Specialized assistance for investors looking to establish ventures
              in Nepal.
            </p>
          </article>
          ...
          <article className="card group hover:-translate-y-1 hover:shadow-lg">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-500">
              End-to-end support for professionals seeking employment
          ...
          <article className="card group hover:-translate-y-1 hover:shadow-lg">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-500">
              Dedicated services for Non-Resident Nepalis returning or staying
              in Nepal.
            </p>
          </article>
        </div>
      ...
      <section id="how-it-works" className="shell mt-20 scroll-mt-32 md:mt-32">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((item) => (
            <article
              key={item.title}
              className="card group hover:-translate-y-1 hover:shadow-lg"
            >
              <div className="mb-4 inline-flex rounded-xl bg-crimson-50 p-3 text-2xl transition group-hover:bg-crimson-100">
        ...
        <div className="card-soft border-slate-300 bg-linear-to-br from-white to-slate-100/70 p-6 md:p-8">
          <div className="mb-7 text-center">
            ...
            <h2 className="page-title mt-3">
              From signup to speaking confidence
            </h2>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {journey.map((step) => (
              ...
              >
                <div className="font-display text-3xl text-crimson-500">
                  {step.n}
                </div>
                <h3 className="mt-2 text-sm font-bold uppercase tracking-wide text-nepal-dark">
                  {step.title}
                </h3>
          ...
          <div className="mt-8 text-center">
            <Link
              to={isAuthenticated ? "/slots" : "/signup"}
          ...
          {testimonials.map((item) => (
            ...
            >
              ...
              <div className="mt-4 flex items-center gap-2">
                <div className="text-[15px] leading-none tracking-[0.06em] text-amber-500">
                  {"★".repeat(item.rating)}
                </div>
      ...
      <section id="faq" className="shell mt-20 scroll-mt-32 md:mt-32">
        ...
        <div className="mx-auto max-w-3xl space-y-3">
          {faqItems.map((item, i) => (
            <div
              key={item.q}
              className="card-soft overflow-hidden p-0 transition hover:shadow-md"
            >
              <button
      ...
      <section id="contact" className="shell my-20 scroll-mt-32 md:my-32">
        ...
        <div className="mx-auto max-w-5xl grid gap-10 md:grid-cols-2 lg:gap-16">
          <div className="flex flex-col justify-center">
            <h3 className="text-xl font-bold text-nepal-dark">
              Have questions?
            </h3>
            <p className="mt-4 text-sm leading-relaxed text-slate-500">
              Whether you're curious about our courses, scheduling, or anything
              else — we're happy to help.
            </p>
            <div className="mt-8 space-y-4">
              <div className="flex items-center gap-4 text-sm text-slate-600">
                <Mail className="h-5 w-5 text-crimson-500" aria-hidden="true" />
